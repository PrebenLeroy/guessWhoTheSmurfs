...
public class PlayGameActivity extends FragmentActivity implements MyListener{
    ...
    @Override
    public void showDetail(GuessWhoTheSmurfsCharacter e) {
        ...
        if (detailFragment != null) {
            ...
            detailFragment.updateDetailView(e);
            ...
            args.putSerializable(DetailFragment.ARG_POSITION, e);
